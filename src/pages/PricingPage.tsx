...
const data = {
  "Системы полива": {
    columns: ["Услуга", "Конкуренты по КК", "Зелёный участок"],
    rows: [
...
const goodValues = ["Бесплатно", "Входит в монтаж", "24 мес.", "3 месяца", "1 месяц"];
  ...
  return (
    <div className="min-h-screen bg-neutral-50 flex flex-col">
      ...
      <div className="flex-1 px-6 py-12 max-w-5xl mx-auto w-full">
            ...
            <thead>
              <tr className="border-b-2 border-neutral-900 bg-neutral-50">
                {table.columns.map((col, i) => (
                  <th
                    key={col}
                    className={`text-left py-4 px-5 text-sm uppercase tracking-wide font-semibold ${
        ...
        {/* CTA */}
        <div className="mt-10 p-8 bg-neutral-900 text-white flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
          <div>
